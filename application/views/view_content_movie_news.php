                ...
                <div id="content" class="layout-sidebar-right group">
                    ...
                    <div id="slogan" class="inner">
                        <h1 class="only">News About <span>Movies</span></h1>
                    </div>         
                    <!-- END SLOGAN --> 
            ...
            <div class="tabs-container">
                ...
                <div class="border-box group">  
                    ...
                    <?php
                        if($latest_movie_news != null){
                            foreach($latest_movie_news as $row){
                ...
                <!-- START SECOND TAB -->
                    ...
                    <div id="primary" class="group" style="width:70%">
                    <?php
                        if($best_movie_news != null){
                            foreach($best_movie_news as $row){
