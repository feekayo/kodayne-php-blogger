                ...
                <div id="content" class="layout-sidebar-right group">
                    ...
                    <div id="slogan" class="inner">
                        <h1 class="only">News About <span>TV Series</span></h1>
                    </div>         
                    <!-- END SLOGAN --> 
            ...
            <div class="tabs-container">
                ...
                <div class="border-box group">  
                    ...
                    <?php
                        if($latest_series_news != null){
                            foreach($latest_series_news as $row){
                            ...
                            echo"<div class=\"hentry hentry-post group blog-small\">
                            <div class=\"thumbnail\">
                                <img src=\"".base_url()."$banner\" class=\"wp-post-image\" alt=\"$title\" title=\"$title\" />                            
                                <p class=\"date\">
                ...
                <!-- START SECOND TAB -->
                    ...
                    <div id="primary" class="group" style="width:70%">
                    <?php
                        if($best_series_news != null){
                            foreach($best_series_news as $row){
